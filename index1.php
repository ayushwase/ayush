...
<html>
 ...
 <div class="main">
  ...
  <a class="navbar-brand" href="#">Alpha<span class="text-warning" style="font-size:1.5em;">A</span>gro</a>
   ...
   <!-- The Modal -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-header">
                <h4 class="modal-title">AlphaAgro Registration</h4>
              ...
              <div class="carousel-inner">
                <div class="carousel-item active" id="demo" >
                  ...
                  <div class="carousel-caption">
                    <h1 class="font-weight-bold" style="font-size: 4em;">Alpha Agro</h1>
                ...
                <div class="carousel-item">
                  ...
                  <div class="carousel-caption">
                    <h1 class="font-weight-bold"style="font-size: 4em;">Alpha Agro Market</h1>
    ...
    <section class="contactsection">
      ...
      <div class="contactheader">
        <h2>Contact Us</h2>
        <p>services.feedback@alphaagro.com | +91 9130894104</p>
      </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4" id="about">
              ...
              <div class="addr mt-4">
              <ul>
              <li class="one mb-2">AlphaAgro Team</li>
              <li class="two mb-2">Walchand Institute of Technology</li>
              <li class="three mb-2">Ashok Chowk area</li>
              <li class="four mb-2">Maharashtra, Solapur. </li>
              <li class="five">413006</li>
            </ul>
            </div>
...
<section>
  <div class="footer">
   <div class="footertext">
     <span class="rights">© 2022 Alpha Agro All rights reserved</span>
      <span class="design p-3 ml-5">© Designed By AlphaAgro & Team</span>
      <div class="iconfooter mt-1">
        <a href="https://www.facebook.com"><i class="fa fa-facebook pr-3"></i></a>
        <a href=""><i class="fa fa-twitter pr-3"></i></a>
        <a href=""><i class="fa fa-instagram "></i></a>
        <a> <p> Translate AlphaAgro </p>
