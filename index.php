            ...
            <div class="modal" id="myModal1">
              <div class="modal-dialog">
                <div class="modal-content">
                  <!-- Modal Header -->
                  <div class="modal-header">
                    <h4 class="modal-title">Alpha Agro Login</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                  </div>
                  <!-- Modal body -->
                  <div class="modal-body">
      ...
      <section class="contactsection">
        <div class="contact">
          <div class="contactheader">
            <h2>Contact Us</h2>
            <p>services.support@alphaagro.com | +91 9130894104</p>
          </div>
      ...
      <section>
        <div class="footer">
          <div class="footertext">
            <span class="rights ml-5">© 2022 Alpha Agro All rights reserved</span>
            <span class="design p-3 ml-5">© Designed By Alpha Agro & Team</span>
