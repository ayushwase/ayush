...
<body>
	<div class="logimg">
		...
		<div class="container">
			<a href="" class="navbar-brand text-warning font-weight-bold" >Sanket Navale</a>
	...
	<div class="col-lg-6 mx-auto mt-5">
		<div class="card">
			...
			<div class="card-header " style="background:linear-gradient( #ffffcc,#e6ffe6)">
				<h3 class="text-center font-weight-bold">AlphaAgro Login Form</h3>
			</div>
			<div class="card-body">
...
$('#login').click(function() {
	...
	if (mobile=="Sanket" && password=="San#17") {
